...
mixin _$PostModel {
 ...
 int get id;@JsonKey(name: 'userId') int get userId; String get title; String get body;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostModel&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.userId, _this.userId) || other.userId == _this.userId)&&(identical(other.title, _this.title) || other.title == _this.title)&&(identical(other.body, _this.body) || other.body == _this.body));
}
...
int get hashCode {
  final _this = this as PostModel;
  return Object.hash(runtimeType,_this.id,_this.userId,_this.title,_this.body);
}

@override
String toString() {
  final _this = this as PostModel;
  return 'PostModel(id: ${_this.id}, userId: ${_this.userId}, title: ${_this.title}, body: ${_this.body})';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'userId') int userId, String title, String body
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'userId')  int userId,  String title,  String body)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'userId')  int userId,  String title,  String body)  $default,) {final _that = this;
switch (_that) {
case _PostModel():
return $default(_that.id,_that.userId,_that.title,_that.body);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'userId')  int userId,  String title,  String body)?  $default,) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.body);case _:
  return null;
...
class _PostModel implements PostModel {
  const _PostModel({required this.id, @JsonKey(name: 'userId') required this.userId, required this.title, required this.body});
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,userId,title,body);
}
